...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PractitionerRole">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/ndh/StructureDefinition/network-reference']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/ndh/StructureDefinition/network-reference': maximum cardinality of 'extension' is 1</sch:assert>
