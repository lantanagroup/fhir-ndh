...
- Query: A distributed or network directory may choose to be compliant with one or more of the Query Conformance statements to indicate the standard Queries and response information provided to their users. See [below](distributed-query-ig.html) for more information about distributed query.
...
- [Distributed Query Actor](distributed-query-ig.html)
